...
\date[2017]{Eighth International Scientific School for Young Scientists "Waves and vortices in complex media".}
...
\begin{figure}
\center \includegraphics[width=0.98\linewidth]{disk2-descr.png} 
\end{figure}}
...
where 
\[
\Delta _{ \bot}  = \partial _{xx} ^{2} + \partial _{yy} ^{2} 
\quad
\Delta  = \Delta_{\bot} +\partial_{zz}^2
\quad
...
\begin{figure}
   \includegraphics[width=0.95\linewidth]{compare.jpg}
\end{figure}
}
...
\begin{enumerate}
\item In general case there are the two types of solutions: regular (internal waves) and three types of singular components of 
...
\item The obtained results show that it is necessary to consider influence of dissipative factors (viscosity, stratification, 
diffusion).
\end{enumerate}
}
...
\frame{\frametitle{}
\begin{center}
\textbf{\textcolor{blue} {Thank you for your attention!}}

\textbf{\textcolor{blue} {Any quesitions?}} 
\end{center}
}
